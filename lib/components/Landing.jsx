...
export default class Landing extends Component {
  render() {
    return (
      ...
      <h1>A computer software engineer and front-end developer</h1>
      <p>I love to spread joy by solving problems, creating memorable user experiences, and giving back to community to shape a better world.</p>
