...
export const Projects = {
  ...
  pathways: {
    imgURL: './lib/imgs/turingpathways.png',
    gifURL: '/lib/imgs/turingpathways.gif',
    hostURL: 'http://turingpathways.herokuapp.com/',
    title: 'Turing Pathways',
    description: 'A Leaflet-powered interactive map and social network designed to allow Turing students and alumni interact in ways never before possible',
    tech: ['JavaScript', 'React', 'Leaflet', 'Node.js', 'Mongo.DB'],
    githubURL: 'https://github.com/MilkMan90/turing-pathways',
  },
};
